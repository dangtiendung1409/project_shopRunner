    ...
    <div class="contain1">
        ...
        <div class="content">
            ...
            <div style="border-top: 1px solid #DDE1EF;" class="content-top1 d-flex flex-wrap">
                ...
                <div class="col-sm-2">
                    <a style="color: #ff5722;font-weight: bold"  type="button" href="{{url("/my-order-confirmed")}}"  >Confirmed</a>
                </div>
                ...
                <div class="col-sm-2">
                    <a style="font-weight: bold; color: #777777"  type="button" href="{{url("/my-order-complete")}}" >Complete</a>
                </div>
