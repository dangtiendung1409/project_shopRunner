...
@section("main")
    ...
    <div class="contain1">
        ...
        <div class="content">
            ...
            <form class="form1" action="{{url("edit-profile")}}" method="post" enctype="multipart/form-data" >
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <input type="tel" value="{{ auth()->user()->tel }}" name="tel" class="form-control" placeholder="Telephone">
                        @error("tel")
                        <p class="text-danger"><i>{{$message}}</i></p>
                        @enderror
                    </div>
                    <div class="form-group col-md-5">
                        <label>Address</label>
                        <input type="text" value="{{ auth()->user()->address }}" name="address" class="form-control" placeholder="Address">
                        @error("address")
                        <p class="text-danger"><i>{{$message}}</i></p>
                        @enderror
                    </div>
                ...
                <button style="background-color: #ff5722; float: right" type="submit" class="btn btn-primary">
                    Submit
                </button>
            </form>
