...
@section("main")
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            ...
            <li style=" background: #c6defd; border-radius: .375rem;"><a  style="color: rgb(22 22 72)" class="app-menu__item" href="{{url("employee/nhan-vien-quan-ly-san-pham")}}"><i
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <div class="tile-body">
                        <form class="row" action="{{url("nhan-vien-add-san-pham")}}" method="post" enctype="multipart/form-data">
                            @csrf
  ...
  MODAL
  -->
    @include("NhanVien.layouts.scripts-formAdd")
    @include("NhanVien.layouts.js_formAddSanPham")
@endsection
